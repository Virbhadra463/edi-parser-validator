...
class EDIParser:
    def detect_transaction(self, raw: str) -> Optional[dict]:
        ...
        if st:
            ...
            if st_code == "837":
                guide = gs[8].strip() if gs and len(gs) > 8 else ""
                guide_map = {
                    "005010X223A2": "837I",
                    "005010X221A1": "837P",
                    "005010X222A2": "837P",
                }
                tx_type = guide_map.get(guide, "837P")
            elif st_code == "835":
                tx_type = "835"
            elif st_code == "834":
                tx_type = "834"
        ...
        return {
            ...
            "implementation_guide": gs[8].strip() if gs and len(gs) > 8 else "",
